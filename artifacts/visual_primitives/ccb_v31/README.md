# CCB Pure Native Draw.io Artifact v31
...
- `ccb_current_best_v31.eval.json` - independent recheck against v30.
- `ccb_text_beam_v23_micro_geometry.report.json` - batched micro-geometry search report that produced this artifact.
...
python3 tools/evaluate_drawio_variants.py \
  ...
  -o artifacts/visual_primitives/ccb_v31/ccb_current_best_v31.eval.json
```
...
v31 applies one accepted text-geometry policy action over v30:

- `selective_base_top_left_text_0036:exploitation:shift_0_0.5`

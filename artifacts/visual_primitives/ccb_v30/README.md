# CCB Pure Native Draw.io Artifact v30
...
- `ccb_current_best_v30.eval.json` - independent recheck against v29.
- `ccb_text_beam_v22_micro_geometry.report.json` - batched micro-geometry search report that produced this artifact.
...
python3 tools/evaluate_drawio_variants.py \
  ...
  artifacts/visual_primitives/ccb_v30/ccb_pure_native_current_best.drawio \
  -o artifacts/visual_primitives/ccb_v30/ccb_current_best_v30.eval.json
```

| Artifact | Score | Edge F1 | OCR F1 | OCR Precision | Changed Pixel Ratio t30 | Pure Native |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| v30 | 0.817476 | 0.7448 | 0.8306 | 0.9328 | 0.164084 | true |
| v29 | 0.816070 | 0.7448 | 0.8267 | 0.9323 | 0.164069 | true |

## Search Action

v30 applies one accepted text-geometry policy action over v29:

- `selective_base_top_left_text_0006:full_zx_calculus:shift_0.5_0`

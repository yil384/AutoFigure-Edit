# CCB Pure Native Draw.io Artifact v25
...
- `ccb_current_best_v25.eval.json` - independent recheck against v24.
- `ccb_text_beam_v17_batch_style.report.json` - batched beam search report that produced this artifact.
...
python3 tools/evaluate_drawio_variants.py \
  ...
  -o artifacts/visual_primitives/ccb_v25/ccb_current_best_v25.eval.json
```
...
v25 applies one accepted text-style policy action over v24:

- `selective_base_bottom_left_text_0069:qft:bold_0`
